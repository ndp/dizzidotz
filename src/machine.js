...
const radiansPerTick = () => (MS_PER_TICK / msPerPeriod$.getValue() * trig.radiansPerPeriod)
...
const normalizeEvent = (e, size) => normalizeValues(eventToPt(e), size)
...
const editorMousedown$ = fromEvent(editor, 'mousedown')
...
/// DELETE ALL
fromEvent(document.getElementById('delete-all-btn'), 'click')
